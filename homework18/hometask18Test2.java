...
class hometask18Test2 {
	...
	public void test() {
		...
		WebElement sortButton = driver.findElement(By.xpath("//a[@data-category = \"review_score_and_price\"]"));
		sortButton.click();
	
		WebElement hotel = driver.findElement(By.xpath("//*[@id=\"hotellist_inner\"]/div[1]/div[2]/div[1]/div[1]/h3/a"));
		hotel.click();//rabotaet tlko na debage

		WebElement rating = driver.findElement(By.xpath("(//div[@class = \"bui-review-score__badge\"])[1]"));
		String linkText = rating.getText();
		Integer ratingInt = Integer.parseInt(linkText);

		assertTrue(ratingInt.equals(9) || ratingInt.equals(10));
